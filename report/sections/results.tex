...
\begin{figure}
    ...
    \caption{\textbf{Comparison of domestic synthetic production costs and import costs for varying import scenarios.}
        ...
        hydrogen production (colorbar). Shown scenarios use technology
...
\begin{figure}
    ...
    to carbonaceous fuels (methane, methanol and Fischer-Tropsch). \textbf{A,C,E}
    show potential system cost savings compared to the scenario without imports.
    \textbf{B,D,F} show the share and composition of different import vectors
    ...
    Ranges in \textbf{A,C,E} show cost savings (\%) for
