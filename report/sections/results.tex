...
\begin{figure}
    ...
    \caption{\textbf{Potential for cost reductions with reduced sets of import options.}
        ...
        savings. Uncertainty ranges show cost savings (\%) for technology
        projection years 2030 and 2050, in addition to the default projection
        for 2040. Cost savings (\%) are also shown for scenarios without steel
        and ammonia relocation. Bottom panel shows composition and extent of
        ...
        and lower import cost assumptions are shown in Supplementary Figs.~XX
        and XX. }
...
system costs by up to \bneuro{37}, using technology projections for 2040. This
corresponds to a relative reduction of 4.4\%, which remains nearly unchanged
regardless of the domestic steel and ammonia production relocation potential.
...
long-term (2050) or near-term (2030) technology projections, do not affect the
...
\begin{figure}
    ...
    \caption{\textbf{Shares of imports and domestic production by carrier, optimised import mix and trade flows.}
        The figure also shows the total supply for each carrier for the import
        scenario with flexible carrier choice. The Sankey diagram aggregates
        trade flows to broader regions to emphasize that alternative
        origin-destination pairs could often yield similar results.  
        Import shares for further import scenarios are included in the
        supplementary material. Steel is included in energy terms applying a
        factor of 2.1 kWh~kg$^{-1}$ as released by the oxidation of iron. }
...
\begin{figure}
    ...
    \caption{\textbf{Comparison of domestic synthetic production costs and import costs for varying import scenarios.}
        ...
        hydrogen production (left colorbar). Confer Supplementary Fig.~XX for
...
The high demand for hydrogen derivatives (\sfigref{fig:si:demands}) means that
...
\begin{figure}
    ...
    \begin{subfigure}[t]{\linewidth}
        \caption{import cost variations applied to all carriers}
        \label{fig:sensitivity-costs:A}
        \includegraphics[width=\linewidth]{../workflow/notebooks/20240826-z1/sensitivity-bars-all-wAC.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{\linewidth}
        \caption{import cost variations applied to all carriers but electricity}
    ...
    \end{subfigure}
    \begin{subfigure}[t]{\linewidth}
        \caption{import cost variations only applied to carbonaceous fuels}
    ...
    Uncertainty ranges in the top subpanels show cost savings (\%) for technology
    projection years 2030 and 2050, in addition to 2040. }
...
\begin{figure}
    ...
    \caption{\textbf{Layout of European energy infrastructure for different import scenarios.}
        ...
        Maps for more scenarios are included in Supplementary Figs.~XX-XX. }
...
(\sfigref{fig:si:relocation}). Not considering relocation of primary steel and
ammonia production would result in a slightly larger hydrogen network of 71~TWkm
(\sfigref{fig:si:infra-b}), while increasing system costs by \bneuro{2.5} (0.3\%)
...
its role in siting fuel synthesis plants (\sfigref{fig:si:infra-b},
