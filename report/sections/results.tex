...
\begin{figure}
    ...
    \caption{\textbf{Shares of imports and domestic production by carrier, optimised import mix and trade flows.}
        ...
        Import shares for further import
        scenarios are included in the supplementary material. Steel is included
        in energy terms applying 2.1 kWh~kg$^{-1}$ as released by the oxidation
        of iron. }
...
By default, we assume islanded fuel synthesis sites which causes
