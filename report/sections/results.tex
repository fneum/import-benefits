...
system costs by up to \bneuro{37}. This corresponds to a relative reduction of
...
\begin{figure}
    ...
    \caption{\textbf{Shares of imports and domestic production by carrier, optimised import mix and trade flows.}
        The figure also shows the total supply for each carrier for import
...
(\sfigref{fig:si:infra-b}), while increasing system costs by \bneuro{22} (2.7\%)
