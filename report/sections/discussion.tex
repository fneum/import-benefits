...
% TB OK, but we all know that results depend on assumptions
% What do we think is robust?
% - some imports are beneficial
% - depending on imports costs, could be 5-40%
% - some PtX in Europe is valuable because of system integration (flexibility, waste heat)
...
% TB A desire for energy sovereignty would motivate more domestic supply and diversified imports. Focusing on ship-bourne imports would reduce pipeline lock-in.
Low reliance on
