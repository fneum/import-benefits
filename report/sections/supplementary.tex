...
% \todo[inline]{relocation and hydrogen demand modelling}
...
\begin{figure*}
    ...
    \caption{\textbf{Layout of European energy infrastructure for different
    import scenarios.}  Infrastructure build-out with technology projection for
    2050 and no imports (first row), with technology projection for 2030 and no
    imports (second row), with technology projection for 2050 and all imports
    ...
    product of the capacity and length of individual connections. }
