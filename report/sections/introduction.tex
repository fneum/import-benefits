...
carbon-based
fuels,\cite{fasihiLongTermHydrocarbon2017,sherwinElectrofuelSynthesis2021,galimovaAnalysisGreenEmethanol2025} or a
...
\begin{figure}
    ...
    \caption{\textbf{Overview of considered import options into Europe.}
        \textbf{A} shows the regional differences in the cost to deliver
        ...
        Aires in Argentina. \textbf{B} depicts considered potential
        ...
        Ukraine and Central Asia. \textbf{C} displays the distribution
        ...
        Costs are given for techno-economic assumptions for 2040.
        Supplementary Fig.~3 shows the world map for lowest
        hydrogen import costs by pipeline or ship into Europe. Maps made with Natural Earth.}
    \label{fig:options}
    }
\end{figure}
